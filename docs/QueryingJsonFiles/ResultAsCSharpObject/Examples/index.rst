...
Example of converting root JSON with JsonQL expressions to a C# object
==================================================

- Sometimes we want to convert the entire JSON to an object (reference or value type) without applying any filters.
