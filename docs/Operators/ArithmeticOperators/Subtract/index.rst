...
Binary operator '-' is used to subtract two numeric values (integer or fractional). 

- If both operands evaluate to valid numeric values, the result will be the subtraction of evaluated values.
