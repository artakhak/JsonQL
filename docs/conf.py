...
master_doc = 'GeneratedDocFiles/index'
...
latex_documents = [
    (master_doc, 'JsonQL.tex', 'JsonQL Documentation',
...
man_pages = [
    (master_doc, 'jsonql', 'JsonQL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'JsonQL', 'JsonQL Documentation',
     author, 'JsonQL', 'One line description of project.',
     'Miscellaneous'),
]
